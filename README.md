...
<ul>
  ...
  <li>Searching, Insertion and Deletion of data belongs to <img src="http://latex.codecogs.com/svg.latex?\inline&space;\fn_phv&space;\large&space;$&space;\textrm{O}(log_3&space;n)$" title="\large $ \textrm{O}(log_3 n)$" /></li>
</ul>
<h2>API</h2>
