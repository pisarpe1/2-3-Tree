...
<p>In order to keep the shape of the tree intact, we have B-Trees that has all its leaves at the same height and is always balanced. 2-3 Tree is a specific form of B-Tree whose order is 3. If we consider the above example and the values in the same order, the 2-3 Tree looks as follows.
...
<ul>
 ...
  <li>Inserting data takes <img src="http://latex.codecogs.com/svg.latex?\fn_phv&space;\large&space;log_3&space;n" title="\large log_3 n" />
</ul>
<h2>API</h2>
